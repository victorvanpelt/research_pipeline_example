...
Reported as the number of observations, mean, standard deviation, minimum, 25th percentile, median, 75th percentile, and maximum. The R engine also gives the count of missing values in parentheses; Stata's `tabstat` has no missing-value statistic, so that engine reports the observation count alone.
